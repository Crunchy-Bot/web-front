...
function Loading(props) {
    let msg = props.msg;
    return (
        <div className="flex flex-col items-center justify-center text-center font-medium outline-none focus:outline-none w-48 mr-4">
    ...
    return (
        <div className="flex flex-col text-white space-y-4 w-full h-full px-4 py-4">
            <div className="flex items-center justify-between text-white text-lg font-bold bg-discord-dark rounded shadow-small-sharp w-2/3 p-4">
                { isLoading ? (
                    <Loading msg={`Profile ${isPublic ? "Public": "Private"}`}/>
                ) : (
                    <button
            ...
            <div className="flex items-center justify-between text-white text-lg font-bold bg-discord-dark rounded shadow-small-sharp w-2/3 p-4">
                { isLoading ? (
                    <Loading msg={`Favourites ${showFav ? "Shown": "Hidden"}`}/>
                ) : (
                    <button
                        onClick={() => toggleFav()}
                        className="flex flex-col items-center text-center outline-none focus:outline-none w-48 mr-4">
            ...
            <div className="flex items-center justify-between text-white text-lg font-bold bg-discord-dark rounded shadow-small-sharp w-2/3 p-4">
                { isLoading ? (
                    <Loading msg={`Watchlist ${showWatch ? "Shown": "Hidden"}`}/>
                ) : (
                    <button
                        onClick={() => toggleWatch()}
                        className="flex flex-col items-center text-center outline-none focus:outline-none w-48 mr-4">
            ...
            <div className="flex items-center justify-between text-white text-lg font-bold bg-discord-dark rounded shadow-small-sharp w-2/3 p-4">
                { isLoading ? (
                    <Loading msg={`Recommended ${showRec ? "Shown": "Hidden"}`}/>
                ) : (
                    <button
                        onClick={() => toggleRec()}
